<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'basic',
        'desc'             => __( 'TНастройки для шаблона', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'             => __( 'Вставьте ваши контактные данные: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
        'fields'           => array(
           
           array(
                'id'       => 'phone-label',
                'type'     => 'text',
                'title'    => __( 'Редактирование поля телефона', 'redux-framework-demo' ),
                'subtitle' => __( 'Введите номер', 'redux-framework-demo' ),
                'desc'     => __( 'Номер телефона', 'redux-framework-demo' ),
                'default'  => 'Call back ',
            ), 
            array(
                'id'       => 'phone-number',
                'type'     => 'text',
                'title'    => __( 'Редактирование поля телефона', 'redux-framework-demo' ),
                'desc'     => __( 'Номер телефона2', 'redux-framework-demo' ),
                'default'  => '',
            ), 
